...
const Exp = () => {
    return (
        <div className='mt-36 font-satoshi font-base text-6xl' id='Exp'> 
            <p className='ml-[252px]'>Experence</p>
            <div className='flex justify-center bg-gradient-to-r from-card via-[#b3d9a0] to-[#c3eaaf] mx-64 rounded-3xl p-7 mt-10 h-[500px]'>
                <div className=' w-2/4 mt-2'>
                    <p className='text-3xl text-left font-semibold'>Food dilevery web application</p>
                    <p className='text-lg text-left mt-4 text-Text'>Worked on a food delivery application using ReactJS, where users can browse
