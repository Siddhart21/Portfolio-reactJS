...
const Skills = () => {
    ...
    return (
        <div className={`mt-36 text-center font-satoshi font-base text-6xl transition-transform duration-700 ease-out ${
            ...
            Skills
            <div className='w-3/4 ml-60 mt-5 bg-blue-back px-28 py-10 rounded-3xl flex-row'>
                ...
                <div className='flex gap-20 justify-around mt-12'>
                ...
                <div className='flex gap-20 justify-around mt-10'>
